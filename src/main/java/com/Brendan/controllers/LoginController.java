...
public class LoginController extends GridPane{
    ...
    @FXML public void handleSubmitButtonAction(ActionEvent e)
    {
        String iD = loginID.getText();

        Stage main = new Stage();

        compLogin = compareLogin(iD, loginPass.getText());
        System.out.println(compLogin);
        dialog.setText("Attempting to log in");
        Stage stage = (Stage) loginButton.getScene().getWindow();

        switch (compLogin)
        {
            case 0:dialog.setText("Sorry that is not a valid login");
                break;
            case 1:dialog.setText("Welcome");
            ...
            case 2: dialog.setText(null);
                ...
                break;
            case 3: dialog.setText("HAHAH you have no power here");
                break;
            case 4: dialog.setText("got an sql exception.My bad");
                break;
